...
class SignUpForm(UserCreationForm):
    user_name = forms.CharField(label="", widget=forms.TextInput(attrs={"class": "form-control", "placeholder": "User Name", }))
    email=forms.EmailField(label="", widget=forms.TextInput(attrs={'class':'form-control','placeholder':'Email Address',}))
    #this allows us to use bootstrap styling.
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields['user_name'].help_text = '<span class="form-text text-muted"><small>Required. 150 characters or fewer. Letters, digits and @/./+/-/_ only.</small></span>'
...
class AddRecordForm(forms.ModelForm):
    ...
    email= forms.EmailField(required=True, widget=forms.widgets.EmailInput(attrs={'class':'form-control','placeholder':'Email Address',}), label="")
